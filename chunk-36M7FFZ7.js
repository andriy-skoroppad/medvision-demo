...
`],encapsulation:2,changeDetection:0})}return i})();var bn=(()=>{class i{static \u0275fac=function(a){return new(a||i)};static \u0275mod=ot({type:i});static \u0275inj=tt({providers:[q],imports:[Rt,Vt,_t,vt,Ut,Va,$t,bt,Dt]})}return i})();function vn(i){let s=e=>e.toString().padStart(2,"0");return`${i.getFullYear()}-${s(i.getMonth()+1)}-${s(i.getDate())}`}function yn(i){if(!i)return null;let[s,e,a]=i.split("-").map(Number);return!s||!e||!a?null:new Date(s,e-1,a)}function Cn(i){if(!i)return null;let s=new Date(i);return Number.isNaN(s.getTime())?null:new Date(s.getFullYear(),s.getMonth(),s.getDate())}function wn(i){return i?new Date(Date.UTC(i.getFullYear(),i.getMonth(),i.getDate())).toISOString():null}export{fn as a,Gt as b,Va as c,bn as d,vn as e,yn as f,Cn as g,wn as h};
